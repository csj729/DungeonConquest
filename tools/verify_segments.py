...
SEGMENTS = [
    (14,  0, [],                               "기본 전투 · 사방 스폰"),
    (10,  4, [],                               "원거리 견제 — 사거리 이탈이 안 통하는 적"),
    ( 9,  6, ["고블린 궁병대장"],               "첫 QTE — 텔레그래프 읽기"),
    ( 9,  6, ["고블린 주술사"],                 "처치 우선순위 — 방치하면 물량이 불어난다"),
    (10,  7, ["고블린 방패병"],                 "광역·방어 관통의 필요성"),
    (11,  9, ["미친 고블린", "고블린 궁병대장"], "종합 — 지속 압박 + QTE"),
    (11, 11, ["고블린 주술사", "고블린 방패병"], "최악의 조합 — 계속 불어나는데 잘 안 죽는다"),
    (13, 13, ["고블린 궁병대장", "미친 고블린",
              "고블린 주술사"],                  "최종 압박 — 보스 직전"),
]

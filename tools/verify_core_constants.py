...
def _check_dev_data():
    ...
    checks = [
        ...
        ("LEVEL_GROWTH_SPEED", ints("LEVEL_GROWTH_SPEED"),
         gd.PROGRESSION["level_growth_speed_permille"][:80]),
        ("LEVEL_GROWTH_DAMAGE", ints("LEVEL_GROWTH_DAMAGE"),
         gd.PROGRESSION["level_growth_damage_permille"][:80]),

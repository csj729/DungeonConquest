...
// data/progression.json — 레벨업 누적 성장 배율 (permille). 파이썬이 거듭제곱을 미리 풀었다.
constexpr int32_t LEVEL_GROWTH_SPEED[80] = {
    1000, 1034, 1070, 1107, 1145, 1184, 1225, 1267, 1311, 1356, 1403, 1451, 1501, 1552,
    1606, 1661, 1718, 1777, 1838, 1902, 1967, 2035, 2105, 2177, 2252, 2330, 2410, 2493,
    2579, 2667, 2759, 2854, 2952, 3054, 3159, 3268, 3380, 3496, 3617, 3741, 3870, 4003,
    4141, 4283, 4430, 4583, 4741, 4904, 5072, 5247, 5427, 5614, 5807, 6007, 6214, 6428,
    6649, 6878, 7114, 7359, 7612, 7874, 8145, 8425, 8715, 9015, 9325, 9646, 9978, 10321,
    10677, 11044, 11424, 11817, 12224, 12644, 13079, 13529, 13995, 14476};
constexpr int32_t LEVEL_GROWTH_DAMAGE[80] = {
    1000, 1034, 1070, 1107, 1145, 1184, 1225, 1267, 1311, 1356, 1403, 1451, 1501, 1552,
    1606, 1661, 1718, 1777, 1838, 1902, 1967, 2035, 2105, 2177, 2252, 2330, 2410, 2493,
    2579, 2667, 2759, 2854, 2952, 3054, 3159, 3268, 3380, 3496, 3617, 3741, 3870, 4003,
    4141, 4283, 4430, 4583, 4741, 4904, 5072, 5247, 5427, 5614, 5807, 6007, 6214, 6428,
...
inline SimConfig devConfig() {
    ...
    for (uint32_t i = 0; i < 80; ++i) {
        c.levelGrowthSpeed[i]  = LEVEL_GROWTH_SPEED[i];
        c.levelGrowthDamage[i] = LEVEL_GROWTH_DAMAGE[i];
    }
